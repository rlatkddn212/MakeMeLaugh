...
public static class CommonSaveData
{
	...
	public static void SetData<TData>(string _key,TData _data)
	{
		s_SaveData.SetData(_key,_data);
	}
	...
	public static TData GetData<TData>(string _key,TData _default = default)
	{
		return s_SaveData.GetData(_key,_default);
	}
