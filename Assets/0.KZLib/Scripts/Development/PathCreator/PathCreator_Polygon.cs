...
namespace KZLib.KZDevelop
{
	public partial class PathCreator : BaseComponent
	{
		...
		private void GetShapePointArray()
		{
			...
			var degrees = (IsReverse ? -1 : +1)*360.0f/m_SideCount;
		...
		public void SetPolygon(Vector3[] _handleArray,float _resolution)
		{
			...
			{
				var distance = (Vector3.Distance(_handleArray[i],m_CenterPosition)/m_Resolution).ToRound(5);
		...
		{
			Gizmos.color = EditorCustom.NormalLineColor;
