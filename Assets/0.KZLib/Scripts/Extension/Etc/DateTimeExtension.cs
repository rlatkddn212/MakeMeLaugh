...
public static class DateTimeExtension
{
	...
	{
		return _legacy ? _dateTime.ToString() : Tools.TimeToText(_dateTime.Hour,_dateTime.Minute,_dateTime.Second);
	}

	public static string ToString(this TimeSpan _timeSpan,bool _legacy)
	{
		return _legacy ? _timeSpan.ToString() : Tools.TimeToText(_timeSpan.Hours,_timeSpan.Minutes,_timeSpan.Seconds);
	}
