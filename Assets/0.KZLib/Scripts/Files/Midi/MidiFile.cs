...
namespace KZLib.KZFiles
{
	public class MidiFile
	{
		...
		private void LoadMidiFile(BinaryReader _reader)
		{
			...
			var chunkSize = Tools.ReadInt32(_reader);
			...
			m_FileFormat = Tools.ReadInt16(_reader);
			int trackCount = Tools.ReadInt16(_reader);

			m_DeltaTicksPerQuarterNote = Tools.ReadInt16(_reader);
